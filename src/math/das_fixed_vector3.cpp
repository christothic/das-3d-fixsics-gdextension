...
//
//     ADD_PROPERTY(PropertyInfo(Variant::INT, "x", PROPERTY_HINT_NONE),
//     "set_x",
//                  "get_x");
//     ADD_PROPERTY(PropertyInfo(Variant::INT, "y", PROPERTY_HINT_NONE),
//     "set_y",
//                  "get_y");
//     ADD_PROPERTY(PropertyInfo(Variant::INT, "z", PROPERTY_HINT_NONE),
//     "set_z",
//                  "get_z");
//
...
//     ClassDB::bind_method(D_METHOD("normalized"),
//     &DASFixedVector3::normalized);
...
//     ClassDB::bind_method(D_METHOD("cubic_interpolate", "other_vector",
//     "pre_a",
//                                   "post_b", "weight"),
//                          &DASFixedVector3::cubic_interpolate);
//
//     ClassDB::bind_method(D_METHOD("slide", "normal"),
//     &DASFixedVector3::slide); ClassDB::bind_method(D_METHOD("bounce",
//     "normal"),
...
//     ERR_FAIL_COND_V_MSG(!other_vector.is_valid(), Variant(), "Invalid
//     type.");
//
//     return DASFixedVector3::from_internal(value +
//     other_vector->get_internal());
// }
//
...
//     return DASFixedVector3::from_internal(
//         DASFixedVector3Internal::linear_interpolate(value,
//         p_to->get_internal(),
//                                                     fixed(weight)));
// }
//
...
//     return Vector3(value.x.to_float(), value.y.to_float(),
//     value.z.to_float());
// }
//
